...
import { useUpdateSingleEscrowForm } from "../../../hooks/single-release/update-single-escrow-form.hook";
...
export function UpdateSingleEscrowForm() {
  const { form, loading, response, fields, append, remove, onSubmit } =
    useUpdateSingleEscrowForm();
